                        ...
                        <div class="col-12">
                            <ul>
                                ...
                                <li class="menu-Item-links rounded dash bg-primary text-white active">
                                   <div>
                                    <i class=" feather-calendar"></i>
                                    <a href="LoanReq.php" class=" text-white">Loan Request</a>
                                   </div>
                                 </li> 
                            ...
                            <div class="card-body">
                                 <div class="headerSection d-flex justify-content-between align-items-center">
                                     <div class="logo d-inline-flex align-items-center">
                                         ...
                                         <h4 class=" mb-0 ms-2">Loan Requests</h4>
                                     </div>
                                 <div>
                                 ...
                                 <h4 class="mt-5">Existing Loan Requests</h4>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                 $stmt = $conn->query("
                                                 SELECT * FROM loans WHERE status = 'pending' AND borrower_id <> " . $_SESSION['userId'] . ";
                                             ");
