                    ...
                    <!-- <div class="row"> -->
                            <div class="col-12 pt-2">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Monthly Payment Calculation (EMI)</li>
                                    </ol>
                                </nav>
                            </div>
                    <!-- </div> -->
                            ...
                            <div class="card-body">
                                 <div class="headerSection d-flex justify-content-between align-items-center">
                                     <div class="logo d-inline-flex align-items-center">
                                         ...
                                         <h4 class=" mb-0 ms-2">Monthly Payment Calculation (EMI)</h4>
                                     </div>
                                 <div>
                                 ...
                                 <hr>
                                 <form action="" method="post" id="emiForm">
                                ...
                                <script>
                                        ...
                                        // Validate inputs
                                        if (isNaN(principal) || isNaN(annualRate) || isNaN(duration) || principal <= 0 || annualRate <= 0 || duration <= 0) {
