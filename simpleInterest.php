                    ...
                    <!-- <div class="row"> -->
                            <div class="col-12 pt-2">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Simple Interest Calculation</li>
                                    </ol>
                                </nav>
                            </div>
                    <!-- </div> -->
                            ...
                            <div class="card-body">
                                 <div class="headerSection d-flex justify-content-between align-items-center">
                                     <div class="logo d-inline-flex align-items-center">
                                         ...
                                         <h4 class=" mb-0 ms-2">Simple Interest Calculation</h4>
                                     </div>
                                 <div>
                                         ...
                                         <div class="row">
                                             <div class="col-12 col-lg-6">
                                                <div class="mt-2">
                                                    ...
                                                    <input type="text" name="amt" id="amt" class=" form-control" value="">
                                                </div>
                                                <div class="mt-2">
                                                <label for="" class=" form-label text-secondary d-block">Interest Rates</label>
                                                        <select name="interest_rate" id="rate" class=" form-control form-select custom-select">
                                                ...
                                                <div class="mt-2">
                                                    <label for="" class=" form-label text-secondary">Duration(Years)</label>
                                ...
                                <script>
                                     ...
                                     document.getElementById("calculateBtn").addEventListener("click", function(event) {
                                        ...
                                        let result= principal*annualRate*duration;
